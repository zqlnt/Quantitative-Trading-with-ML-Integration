"""
Auto Summary & Promotion Decision Generator

This module generates decision-grade summaries after each backtest run,
including promotion decisions based on quantitative criteria.
...
class SummaryGenerator:
    """
    Generates decision-grade summaries and promotion decisions for backtest runs.
    
    This class analyzes run artifacts and generates comprehensive summaries
    including executive summaries, significance verdicts, and promotion decisions.
    """
    ...
    def generate_summary(self, 
        ...
        """
        Generate a comprehensive summary for a backtest run.
